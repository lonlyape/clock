...
$.extend({
	clock:function (options){
		...
		function needle(h,m,s){
			...
			line({x:0,y:option.needle.hour.longOut},h,option.needle.hour.length , option.needle.hour.color , option.needle.hour.lineWidth);		//时针
			line({x:0,y:option.needle.minute.longOut},m,option.needle.minute.length , option.needle.minute.color , option.needle.minute.lineWidth);	//分针
			line({x:0,y:option.needle.second.longOut},s,option.needle.second.length , option.needle.second.color , option.needle.second.lineWidth);	//秒针
